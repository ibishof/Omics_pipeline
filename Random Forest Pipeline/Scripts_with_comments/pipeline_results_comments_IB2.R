...
saveRDS(msdss_mod,"msdss_mod.rds")
...
write.csv(soma_train, "soma_trainb.csv")
write.csv(soma_test, "soma_testb.csv")
write.csv(soma_untreated, "soma_untreatedb.csv")
...
write.csv(msdss_imp_dat, "msdss_imp_dat116.csv")
