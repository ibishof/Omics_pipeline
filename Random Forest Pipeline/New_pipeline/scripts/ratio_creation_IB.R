...
##################################################################
setwd("C:\\Users\\bishofij\\Proteomics_Pipeline\\NIH\\Bibi\\soma_5k")
...
# Load the metadata
soma_untreated <- read_csv("preratio.csv")
...
saveRDS(soma_dt,"ratios_training.rds")
write.csv(soma_dt,"ratios_training.csv")
