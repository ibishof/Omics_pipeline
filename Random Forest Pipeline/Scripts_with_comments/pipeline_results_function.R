#####################################################################################
# This function looks into a folder that contains pipeline results, 
# prints the iteration with the smallest out-of-bag (OOB) MSE, and returns a figure 
# displaying the OOB error, with a vertical line drawn at the best iteration.
# Alternatively, you can prespecify where the best iteration line goes using 
# the best_iter argument
#####################################################################################
